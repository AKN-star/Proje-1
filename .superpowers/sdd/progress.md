...
| 4 — Soru/Cevap + başlık önerisi | devam ediyor | Branch `faz-4-soru-cevap` (faz-3 üstüne). T1 tamam: questions+answers (migration 0005), mod_ban enum + banUser logu. T2 tamam: lib/qa + validation/qa + actions/qa (submitQuestion/submitAnswer/voteAnswer), 123/123 test yeşil, push'landı. W3 çalışıyor: T3 (QA UI: topic Sorular bölümü, /soru-sor, /soru/[id]) + T4 (/baslik-oner + admin başlık önerileri) paralel worktree ajanlarında. Kalan: W3 merge+doğrulama, canlı doğrulama, final review, PR #5. |
